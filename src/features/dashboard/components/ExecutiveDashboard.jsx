 ...
 */
export function ExecutiveDashboard({ profileId }) {
  ...
  useEffect(() => {
    ...
    async function loadDashboard() {
      ...
      const { data: dashboardData, error: loadError } =
        await getExecutiveDashboard(supabase, profileId);
  ...
  if (!data) {
    return (
      <EmptyState
        ...
        description="Your metrics are unavailable right now. Try refreshing the page."
      />
    );
  }
